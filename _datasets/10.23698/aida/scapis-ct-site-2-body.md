...
datacite:
  ...
  "@type": "Dataset"
  "@id": "https://doi.org/10.23698/aida/scapis-ct-site-2-body"
  name: "SCAPIS body data from site 2"
  about: "Radiology"
  url: "https://datahub.aida.scilifelab.se/10.23698/aida/scapis-ct-site-2-body"
  author:
    - "name": SCAPIS
...
other:
  modality:
  - "CT"
  shortName: "SCAPIS-CT-SITE-2-BODY"
  origin: "Clinical"
  status: "Ongoing"
  countries-shared:
  - "SE"
...
---
## File formats
The dataset consists of 7z compressed archives containing a total of 193246 .dcm files.
