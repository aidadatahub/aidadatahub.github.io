...
datacite:
  ...
  description: |
    ...
    **Note**: if you want to use real brain tumor images, use the [BraTS dataset](http://www.braintumorsegmentation.org/) (which we used to create these synthetic images).
  license:
